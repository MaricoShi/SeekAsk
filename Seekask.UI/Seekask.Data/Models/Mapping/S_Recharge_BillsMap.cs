...
{
    public class S_Recharge_BillsMap : EntityTypeConfiguration<S_Recharge_Bills>
    {
        public S_Recharge_BillsMap()
        {
            // Primary Key
            this.HasKey(t => t.SerialNo);

            // Properties
            this.Property(t => t.RechargeTitle)
                .HasMaxLength(100);
            ...
            this.ToTable("S_Recharge_Bills");
            this.Property(t => t.SerialNo).HasColumnName("SerialNo");
            this.Property(t => t.RechargeTitle).HasColumnName("RechargeTitle");
            ...
            this.Property(t => t.UseTimes).HasColumnName("UseTimes");
